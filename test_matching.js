...
function onResult (decodeResults, readerProperties, output)
{
	...
	if (decodeResults[0].decoded)
	{
		...
		var is_contain = decodeResults[0].content.toLowerCase().indexOf(str_template);
		if(is_contain != -1)
		{
	...
	return {
        ...
        */
		onExpectedData: function (inputString) {
            ...
            else if (inputString == "out0_on") {
                dmccSet("output.action", 0, 1);
                msg = "x out 0 -> ON";
            }
            else if (inputString == "out0_off") {
                dmccSet("output.action", 0, 0);
                msg = "x out 0 -> OFF";
            }
            else if (inputString == "out1_on") {
                dmccSet("output.action", 1, 1);
                msg = "x out 1 -> ON";
            }
            else if (inputString == "out1_off") {
                dmccSet("output.action", 1, 0);
                msg = "x out 1 -> OFF";
            }
